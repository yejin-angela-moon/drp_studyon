...
// 10 libraries
                ...
                StudyLocation(
                    ...
                    rating: 4.2,
                    comments: [],
                    images: ["maidaValeLibrary1", "maidaValeLibrary2", "maidaValeLibrary3"],
                    hours: sampleHours,
                    envFactor: sampleEnvFactors,
                    num: 4,
                    category: "library"
...
// 20 libraries
                ...
                StudyLocation(
                    ...
                    rating: 4.0,
                    comments: [],
                    images: ["pretEarlsCourt1", "pretEarlsCourt2"],
                    hours: sampleHours,
                    envFactor: sampleEnvFactors,
                    num: 4,
                    category: "cafe"
                ...
                StudyLocation(
                    ...
                    rating: 3.4,
                    comments: [],
                    images: ["starbucksKensingtonHighSt1", "starbucksKensingtonHighSt2"],
                    hours: sampleHours,
                    envFactor: sampleEnvFactors,
                    num: 4,
                    category: "cafe"
